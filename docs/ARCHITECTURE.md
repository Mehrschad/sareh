...
- **دو گونه از دوازده گونه** نیامده‌اند و هر دو دلیلِ بیرونی دارند:
  «گفتار» به میکروفون نیاز دارد و مادرْ‌سند خودش اختیاری‌اش خوانده، و
  «رویارویی» به بک‌اند نیاز دارد و فازِ دوم است. «شنیدار» از پروژه برداشته
  شد؛ اگر روزی صدا آمد، برمی‌گردد.
- **نرخِ برگشت به «گزینش».** هر گونه داده‌ی خودش را می‌خواهد و اگر نباشد
  موتور به گزینش برمی‌گردد. اندازه‌گیری‌شده روی پیکره‌ی کنونی:

  | گونه | می‌سازد | چرا نه بیشتر |
  |---|---|---|
  | گزینش · جفت‌ساز · جای‌گزینی · نویسش · داستانک · تیر آرش · بیت‌یاب | ۱۰۰٪ | — |
  | واژه‌چین | ۹۲٪ | نمونه‌های زیر سه واژه |
  | ریشه‌یاب | ۵۰٪ | ۲۴۰ از ۴۷۷ واژه ریشه‌ی ثبت‌شده دارند |
- **بسته‌های نمادِ دوم و سوم** («کهن» و «هندسی») هنوز نیامده‌اند؛ تنها
  «اسطوره» هست.
- **صدا** نیمه‌آمده: ضرب‌های بازخورد (سنتورِ ساختگی، ۱۷۳KB) هستند؛
  صدای واژه‌ها — آنچه «شنیدار» لازم دارد — هنوز نیست، پس شنیدار هم
  برنگشته. تار و دف هم هنوز.
